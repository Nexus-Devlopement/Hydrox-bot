  ...
  run: async (client, message) => {
   ...
   const { default_prefix } = require("./../../config.json");
    ...
    let button_public_invite = new MessageButton().setStyle('url').setLabel('Invite Public Bot').setURL("https://discord.com/api/oauth2/authorize?client_id=882311254423765012&permissions=8&scope=bot")
      let button_support_dc = new MessageButton().setStyle('url').setLabel('Support Server').setURL("https://discord.gg/notsaksh")
    ...
    let mybuttonsmsg = await message.channel.send({
        embed: new MessageEmbed()
          .setColor("RANDOM")
          .setTitle("<a:Hearts:935500566291951628> You Need Help? **JOIN OUR SUPPORT SERVER**")
          .setDescription(`**[Invite Uptimer](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)  •  [Support Server](https://discord.gg/notsaksh)**`)
          .setFooter("Hydrox", "https://media.discordapp.net/attachments/882623206853337158/882673120929005578/discord-avatar-512-T4KXQ-removebg-preview.png?width=469&height=469")
