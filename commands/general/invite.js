...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let mybutton1 = new MessageButton() // prettier
      .setStyle('url').setLabel("Support Server").setURL("https://discord.gg/notsaksh") // XDD Change this
    ...
    return message.channel.send({
      ...
      .setColor("RANDOM")
      .addField(
        "<:arrow:934482036377419866> **Invite Me**",
        "[Click here](" + invite_link + ") To Invite Me To Your Server."
      )
      .addField(
        "<:arrow:934482036377419866> **Support Server**",
        "[Click here](https://discord.gg/notsaksh) To Join Our Support Server."
      )
      .setTimestamp()
      ,
        buttons: allbuttons
