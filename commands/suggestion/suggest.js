...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    const done = new MessageEmbed()
       .setDescription(`<a:yes:933239140718358558> | Your suggestion is Submitted here, <#${channel}>\n\nNote: You agreed to get a DM on a reply over your Suggestion!`)
       .setColor("00FFFF")
    ...
    await msgEmbed.react('<:upvote:935512815664508979>')
    await msgEmbed.react('<:downvote:935512958174380053>')
  }
}