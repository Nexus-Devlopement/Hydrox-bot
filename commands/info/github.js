  ...
  try {
   if (!args[0])
    return message.lineReply({
     embed: {
      color: 16734039,
      description: "<:no:933239221836206131> | Please Enter A Github username",
     },
    });
    ...
    .then((body) => {
     if (body.message)
      return message.lineReply({
       embed: {
        color: 16734039,
        description: "<:no:933239221836206131> | 0 Users Found, Please Provide Vaild Username",
       },
      });
     ...
     const embed = new Discord.MessageEmbed() // Prettier()
      ...
      .addField(`<:Users:935062282097012776> Username`, `\`\`\`${login}\`\`\``)
