    ...
    try {
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:no:933239221836206131> Please include to which track you want to jump`)
      ...
      if (isNaN(args[0]))
        return message.channel.send(new MessageEmbed()
          ...
          .setColor(ee.wrongcolor)
          .setTitle(`<:no:933239221836206131> It has to be a queue **Number**`)
        );
      ...
      if (Number(args[0]) > player.queue.size)
        return message.channel.send(new MessageEmbed()
          ...
          .setColor(ee.wrongcolor)
          .setTitle(`<:no:933239221836206131> That song is not in the queue, sorry!`)
        );
      ...
      return message.channel.send(new MessageEmbed()
        ...
        .setTitle(`<:no:933239221836206131> An error occurred`)
