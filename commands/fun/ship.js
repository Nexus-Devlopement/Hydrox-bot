  ...
  try {
   ...
   if (!user1) {
    return message.channel.send({
     embed: {
      color: 16734039,
      description: "<:no:933239221836206131> | Please mention a user to ship!",
     },
    });
   }
   const user2 = args[1];
   if (!user2) {
    return message.channel.send({
     embed: {
      color: 16734039,
      description: "<:no:933239221836206131> | Please mention a secound user to ship!",
     },
    });
   }
   const ship = Math.floor(Math.random() * 100) + 1;
   const bar = progressbar(100, ship, 10, "<:middle_filled:935059715459797012>", "<:middle_empty:935059487797178468>", "💔 ", " ❤️", false);
   ...
   message.channel.send({
    embed: {
     color: 16734039,
     description: "<:no:933239221836206131> Somthing Wents Wrong",
    },
   });
  }
 },
