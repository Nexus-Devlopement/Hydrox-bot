...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .setTitle("<:no:933239221836206131> No Valid Url Provided!")
    ...
    if (checkIfExsists === null) {
      ...
      await UrlsConfig.create({
        ...
        let embed = new MessageEmbed()
          .setTitle("<a:yes:933239140718358558> Added Succesfully!")
      ...
      let embed = new MessageEmbed()
        .setTitle(
          "<a:r_dot:935066570630262854> Project is already Registered!"
        )
        .setDescription(
