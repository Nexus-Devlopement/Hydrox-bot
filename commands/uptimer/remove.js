...
module.exports = {
  ...
  run: async (client, message, args) => {
      ...
      collector.on("collect", async (reaction) => {
        switch (reaction.emoji.name) {
          case "1️⃣": {
            ...
            let embed = new MessageEmbed()
              .setTitle("<a:yes:933239140718358558> Removed Succesfully!")
    ...
    if (!validUrl.isUri(url)) {
      return message.channel.send("<:no:933239221836206131> Please provide a vaild url!");
    }

    // LOADING
    let waitEmbed = new MessageEmbed().setDescription(
      "<a:loading:933964409661972491> Please wait..."
    );
    ...
    if (checkIfExsists === null) {
      ...
      let embed = new MessageEmbed()
        .setTitle("<a:r_dot:935066570630262854> Project is not Registered!")
