...
module.exports = {
  ...
  run: async (client, message, args ) => {
      //--------------------------------------S T A R T---------------------------------------
        ...
        .setTitle('<:DotInfo:935497986027429899> How to Use Uptimer!')
        .addField("<:arrow:934482036377419866> **Get the link**",
      ...
      .setTitle('<:DotInfo:935497986027429899> How to Use Uptimer!n')
      .addField("<:arrow:934482036377419866> **Run the command**",
      ...
      .setTitle('<:DotInfo:935497986027429899> How to Use Uptimer!n')
      .addField("ㅤ<:arrow:934482036377419866> **Other Commands**","Now that we have added your project, you can use other command such as `projects` `remove` `stats` and `total`. Below Is an image of the remove command")
