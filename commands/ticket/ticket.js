...
module.exports = {
    ...
    run: async(client, message, args) => {
      ...
      .setDescription('**[<:click_to_create_ticket:935513821131468851>] Click to open ticket**')
      ...
      const success = new MessageEmbed()
       .setTitle("Success!")
       .setDescription(`[<:click_to_create_ticket:935513821131468851>] The ticket was configured. To see it go to ${channel}`)
       .setColor("GREEN")
