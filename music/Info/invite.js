...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_support_dc = new MessageButton().setStyle('url').setLabel('Support Server').setURL("https://discord.com/invite/notsaksh")
      ...
      message.channel.send({
        embed: new MessageEmbed()
          ...
          .addField(`<:Discord:933249753955860490> Nexus Development`, `**[WEBSITE](https://notsakshy.com)  •  [Support Server/Get your Own Bot](https://discord.com/invite/notsaksh)**`)
